...
<!-- ORDER -->
        ...
        <li class="nav-item"><a class="nav-link <?php if($active=='order'){echo 'text-warning';} ;?>" href="index.php?hal=order">
            <svg class="nav-icon">
              <use xlink:href="../../bootstrap-icons/bootstrap-icons.svg#basket"></use>
            </svg> Order Steam<span class="badge badge-sm bg-info ms-auto">NEW</span></a></li>
      </ul>
      ...
      <header class="header header-sticky mb-4">
        <div class="container-fluid">
          ...
          <a class="header-brand d-md-none" href="#">
            <svg width="118" height="46" alt="Dashboard Logo">
              <use xlink:href="../../bootstrap-icons/bootstrap-icons.svg#emoji-smile"></use>
            </svg>
          </a>
          ...
          <ul class="header-nav ms-3">
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-end pt-0">
                ...
                </div><a class="dropdown-item" href="../../login/login.php">
                  <svg class="icon me-2">
